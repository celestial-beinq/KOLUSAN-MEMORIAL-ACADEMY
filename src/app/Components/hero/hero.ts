  ...
  slides: HeroSlide[] = [
    {
      ...
      subtext: 'At Kolusan Memorial High School, we provide an inspiring learning environment combining academic excellence, innovative STEM training, and moral discipline to prepare every child for global success.',
